...
val Manga.downloadedFilter: TriState
    get() {
        if (globalAppGraph.basePreferences.downloadedOnly().get()) return TriState.ENABLED_IS
...
fun Manga.hasCustomCover(coverCache: CoverCache = globalAppGraph.coverCache): Boolean {
