...
object LocalLlmCatalog {
    ...
    val allModels: List<LocalLlmModel> = listOf(
        ...
        LocalLlmModel(
            ...
            description = "Alibaba's Qwen3 4B — strong text-only quality for its size, a solid step up from the 1B class.",
            paramsB = "4B",
            qualityTier = 4,
            isTranslationFinetune = false,
            supportsVision = false,
            sizeBytes = 2_889_514_272L,
            minRamBytes = 4L * 1024 * 1024 * 1024,
            ggufRepo = "unsloth/Qwen3-4B-GGUF",
            ggufFile = "Qwen3-4B-Q5_K_M.gguf",
            contextLength = 4096,
            defaultSampling = LocalLlmSamplingConfig(
                temperature = 0.3f,
                repeatPenalty = 1.0f,
        ...
        LocalLlmModel(
            ...
            description = "Alibaba's Qwen3 1.7B — compact text-only model, a good middle ground between Llama 3.2 1B and the 4B class.",
            paramsB = "1.7B",
            qualityTier = 2,
            isTranslationFinetune = false,
            supportsVision = false,
            sizeBytes = 1_257_880_128L,
            minRamBytes = 3L * 1024 * 1024 * 1024,
            ggufRepo = "unsloth/Qwen3-1.7B-GGUF",
            ggufFile = "Qwen3-1.7B-Q5_K_M.gguf",
            contextLength = 4096,
            defaultSampling = LocalLlmSamplingConfig(
                temperature = 0.3f,
                repeatPenalty = 1.0f,
